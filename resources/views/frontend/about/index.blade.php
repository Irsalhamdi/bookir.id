...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Ubuntu:ital,wght@0,300;0,400;1,700&display=swap" rel="stylesheet">
  ...
  <body>
        ...
        <div class="container-fluid position-fixed" id="nav">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-dark bg-light bg-transparent py-3">
            ...
            <div class="container">
                <div class="row postion-relative">
                    <div class="col-lg-5 col-md-6 offset-lg-1 my-auto order-1 text-center text-lg-start">
                        <h2>Halo</h2>
                        <h1 class="fw-bold">I Am Irsal Hamdi</h1>
                        <p>
                            Front End Developer || Back End Developer <br> 
                            1 Years Experienced <span class="fw-bold color-acsent"> As Front End and Back End </span>
                        </p>
                        <button class="btn btn-custom1">
                            Let's Talk
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" class="my-1" viewBox="0 0 38.044 31.65">
                        ...
                        <div class="social-icon position-absolute bottom-0">
                            <a target="_blank" href="https://id.linkedin.com/in/irsal-hamdi-585623197">
                            ...
                            <a target="_blank" href="https://github.com/Irsalhamdi?tab=repositories">
                            ...
                            <a target="_blank" href="https://www.youtube.com/channel/UCjcShpNPRpp_OzWTzRcJNzQ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" viewBox="0 0 40.402 28.59">
                                    <path id="youtube" d="M32.011,67.393H8.391A8.391,8.391,0,0,0,0,75.784V87.592a8.391,8.391,0,0,0,8.391,8.391h23.62A8.391,8.391,0,0,0,40.4,87.592V75.784A8.391,8.391,0,0,0,32.011,67.393ZM26.336,82.262,15.289,87.532a.444.444,0,0,1-.634-.4V76.263a.443.443,0,0,1,.644-.4l11.048,5.6A.444.444,0,0,1,26.336,82.262Z" transform="translate(0 -67.393)" fill="#fff"/>
                                </svg>
                            </a>
                            <a target="_blank" href="https://www.instagram.com/irslhmd/">
                                <svg id="instagram" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 31.925 31.931">
                            ...
                            <br>
                            <a href="#" class="fw-bold text-decoration-none cv">
                                Download <span class="color-acsent">Curriculum Vitae</span>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-6 order-md-2">
                        <img src="{{ asset('frontend/assets/images/irsalhamdi.jpg') }}" width="80%" class="float-lg-end mx-auto d-block rounded-circle">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-10 col-md-12 mt-3">
                            <p class="text-center color-acsent">
                                Teknologi hanyalah alat, positif dan negatif tergantung siapa yang menggunakannya
                            </p>
                            <p class="text-center">
                                Saya seorang pengembang perangkat lunak yang pekerja keras dan berpikiran terbuka dengan tim dan individu. Senang untuk belajar hal baru dan mudah untuk beradaptasi dengan orang-orang baru dan juga tipe orang yang suka menunjukkan intergritas
        ...
        <section id="skill">
            <div class="container-fluid">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-10">
                            <h1 class="fw-bold text-center">Skills</h1>
                            <hr>
                        </div>
                        <div class="col-lg-10 col-md-12 text-center mt-3">
                            <img src="{{ asset('frontend/assets/images/ms office.png') }}" alt="">
                            <img src="{{ asset('frontend/assets/images/psd.png') }}" alt="">
                            <img src="{{ asset('frontend/assets/images/ai.png') }}" alt="">
                            <img src="{{ asset('frontend/assets/images/pr.png') }}" alt="">
                            <img src="{{ asset('frontend/assets/images/corel.png') }}" alt="">
                            <img src="{{ asset('frontend/assets/images/xd.png') }}" alt="">
                            <img src="{{ asset('frontend/assets/images/css.png') }}" alt="">
                            <img src="{{ asset('frontend/assets/images/git.png') }}" alt="">
                            <img src="{{ asset('frontend/assets/images/html.png') }}" alt="">
                            <img src="{{ asset('frontend/assets/images/javascript.png') }}" alt="">
                            <img src="{{ asset('frontend/assets/images/react.png') }}" alt="">
                            <img src="{{ asset('frontend/assets/images/figma.png') }}" alt="">
                        </div>
                    </div>
                    <div class="row justify-content-center skill-content">
                        <div class="col-lg-3 col-md-4 col-sm-10">
                            <div class="card p-4">
                                <div class="row text-center text-sm-start">
                                    <div class="col-sm-12">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="90" viewBox="0 0 140.938 135.295">
                                    ...
                                    <div class="col pt-3">
                                        <h3 class="text-sm-start fw-bold text-center">Graphic <br> Design</h3>
                                        <p class="text-start">
                                            1 Tahun bekerja sebagai graphic design, membuatku bertumbuh dan memiliki wawasan yang luas di dunia design graphic
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <section id="portofolio">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h1 class="text-center fw-bold">Galery Portofolio</h1>
                        <hr>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-12 d-flex pt-5">
                        <div class="card border-3 m-1">
                            <img src="{{ asset('frontend/assets/images/vocasia.png') }}" alt="">
                            <a target="_blank" href="https://github.com/Irsalhamdi/vocasia-web-project" class="btn btn-success btn-sm">Resources</a>
                        </div>
                        <div class="card border-3 m-1">
                            <img src="{{ asset('frontend/assets/images/ecommerce.png') }}" alt="">
                            <a target="_blank" href="https://github.com/Irsalhamdi/ecommerce" class="btn btn-success btn-sm">Resources</a>
                        </div>
                        <div class="card border-3 m-1">
                            <img src="{{ asset('frontend/assets/images/bookir.png') }}" alt="">
                            <a target="_blank" href="https://github.com/Irsalhamdi/Bookir" class="btn btn-success btn-sm">Resources</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <footer class="py-5" id="contact">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <p class="text-light">Thanks For Scrolling, That's All Folks</p>
                    </div>
    ...
    <script src="{{ asset('frontend/assets/js/about.js') }}"></script>    
