            ...
            <div class="card-body">
                ...
                <div class="row" style="margin-left: 30px; margin-top: 20px;">
                    ...
                    <div class="col-md-2">
                        ...
                        {{ $track->province->name }} / {{ $track->regency->name }} / {{ $track->district->name }} / {{ $track->village->name }}
                    </div>
                    <div class="col-md-2">
                ...
                <div class="track">
                    ...
                    @elseif($track->status == 'picked')
                        ...
                        <div class="step active"> 
                            <span class="icon"> 
                            <i class="fa fa-check"></i> 
                            </span> <span class="text">Order Pending</span> 
                        </div>
                    ...
                    @elseif($track->status == 'delivered')
                        ...
                        <div class="step active"> 
                            <span class="icon"> 
                                <i class="fa fa-check"></i> 
                            </span> <span class="text"> Order Processing  </span> 
                        </div>

                        <div class="step active"> 
                            <span class="icon"> 
                                <i class="fa fa-check"></i> 
                            </span> <span class="text">Order Picked</span> 
                        </div>

                        <div class="step active"> 
                            <span class="icon"> 
                                <i class="fa fa-check"></i> 
                            </span> <span class="text">Order Shipped </span> 
                        </div>
